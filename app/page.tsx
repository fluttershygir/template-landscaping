...
import { CheckCircle2, Phone, ArrowRight, Flower2, Trees } from "lucide-react";
    ...
    <div className="min-h-screen bg-slate-950 text-slate-50 font-sans">
      ...
      <section className="relative pt-32 pb-20 md:pt-48 md:pb-32 overflow-hidden">
        ...
        <div className="container mx-auto px-6 text-center max-w-4xl">
          ...
          <p className="text-xl text-slate-400 mb-10 max-w-2xl mx-auto leading-relaxed">
            From lush lawn maintenance to stunning hardscape design, we create environments you will love to come home to.
          </p>
      ...
      <section className="py-12 bg-slate-900/50 border-y border-slate-800">
        <div className="container mx-auto px-6 grid grid-cols-2 md:grid-cols-4 gap-8">
          {(["Satisfaction Guarantee", "Reliable Schedule", "Top Rated Service", "Eco-Friendly"] as string[]).map((label, i) => (
      ...
      <section className="py-24">
        <div className="container mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {([
              { title: "Lawn Maintenance", desc: "Weekly mowing, fertilization, and weed control to keep your grass thick and green.", icon: Flower2 },
              { title: "Landscape Design", desc: "Custom garden planning, planting, and hardscaping including patios and walkways.", icon: Trees },
              { title: "Seasonal Cleanup", desc: "Spring and fall debris removal, mulching, and pruning to prepare for the season.", icon: CheckCircle2 },
            ] as { title: string; desc: string; icon: React.ElementType }[]).map((service, i) => (
              <Card key={i} className="bg-slate-900 border-slate-800 hover:border-emerald-500/50 transition-colors group">
                ...
                <CardContent>
                  ...
                  <div className="flex items-center text-sm font-medium text-emerald-400 cursor-pointer">
